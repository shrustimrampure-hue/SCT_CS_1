...
🔑 Features
Dual Mode Functionality: Supports both Encryption (e) and Decryption (d) using the same core logic.

Reversible Logic: Decryption is handled efficiently by applying a negative key shift, effectively reversing the encryption process. The relationship is:
